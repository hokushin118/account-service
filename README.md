...
4. **Run Integration Tests:**
   ...
   ```bash
   APP_SETTINGS=testing RUN_INTEGRATION_TESTS=true nosetests -v --with-spec 
   --spec-color tests/integration
   ```
    * `APP_SETTINGS=testing`: Specifies the 'testing' configuration profile for the application.
