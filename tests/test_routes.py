...
class TestAccountService(TestCase):  # pylint: disable=too-many-public-methods
    ...
    def test_health(self):
        ...
        resp = self.client.get(HEALTH_PATH)
    ...
    def test_find_by_id_not_found(self):
        ...
        resp = self.client.get(f"{ACCOUNTS_PATH_V1}/0")
    ...
    def test_update_by_id_not_found(self):
        """It should not Read an Account that is not found."""
        resp = self.client.put(f"{ACCOUNTS_PATH_V1}/0")
        self.assertEqual(resp.status_code, status.HTTP_404_NOT_FOUND)
    ...
    def test_partial_update_by_id_not_found(self):
        """It should not Read an Account that is not found."""
        resp = self.client.patch(f"{ACCOUNTS_PATH_V1}/0")
        self.assertEqual(resp.status_code, status.HTTP_404_NOT_FOUND)

    def test_delete_by_id(self):
        """It should Delete an Account."""
        account = self._create_accounts(1)[0]
        resp = self.client.delete(f"{ACCOUNTS_PATH_V1}/{account.id}")
